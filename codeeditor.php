<?php
  ...
  function showEditor($content, $file_name, $file_ext) {
    ...
    echo '<textarea id="ace_code" name="ace_code" rows="20" data-theme="'.FM_ACE_THEME.'" data-keybinding="'.FM_ACE_KEYBINDING.'" data-height="'.FM_ACE_HEIGHT.'" data-behaviors="'.FM_ACE_BEHAVIORS.'">'.$content.'</textarea>';
